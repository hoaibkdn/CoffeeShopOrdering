		...
		<div class="col-md-10 col-xs-10 drink-group">
			...
			<div class="col-md-4 col-sm-4">
				...
				<div class="col-md-12 name-price">
					...
					<p id="price"><%=drink.getPrice()%></p>
					<div id="quantity">
						<p>&nbsp;</p>
						<input class="form-control" type="number"
							name="drinkQuantityInput"
							id="drinkQuantity<%=drink.getDrinkID()%>" value="0"
							onchange="changeAddBtn(this,'<%=drink.getDrinkID()%>')" min="-5" />
						<button class="btn btn-success"
							id="addDrink<%=drink.getDrinkID()%>"
							onclick="addDrink('<%=drink.getDrinkID()%>')" disabled>Add</button>
					</div>
				</div>
			</div>
			<%
			...
			%>
			<%
				if (listAllDrinks.size() == 1) {
			%>
			<div class="col-sm-2 col-sm-offset-6">
				<button class="btn btn-default btn-block"
					style="margin-top: 13.5em;" onclick="goBack()">Back</button>
			</div>
			<%
				}
			%>
